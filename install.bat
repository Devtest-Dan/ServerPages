...
powershell -Command "& { [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://github.com/Devtest-Dan/ServerPages/archive/refs/heads/main.zip' -OutFile '%REPO_ZIP%' }" 2>nul
...
xcopy "%REPO_EXTRACT%\ServerPages-main\*" "%INSTALL_DIR%\" /E /Y /Q >nul 2>&1
